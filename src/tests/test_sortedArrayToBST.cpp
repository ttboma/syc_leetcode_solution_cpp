...
BOOST_AUTO_TEST_CASE( example1 ) {
	...
	auto t1 = new TreeNode(0, new TreeNode(-3, new TreeNode(-10), nullptr), new TreeNode(9, new TreeNode(5), nullptr));
	auto t2 = new TreeNode(0, new TreeNode(-10, nullptr, new TreeNode(-3)), new TreeNode(5, nullptr, new TreeNode(9)));
